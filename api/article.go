...
func (articleApi *ArticleApi) ArticleLike(c *gin.Context) {
	...
	response.OkWithMessage("Article liked/uncollected successfully", c)
}
...
func (articleApi *ArticleApi) ArticleInfoById(c *gin.Context) {
	...
	article, err := articleService.ArticleInfoById(c.Request.Context(), req.ID)
	if err != nil {
...
func (articleApi *ArticleApi) ArticleSearch(c *gin.Context) {
	...
	list, total, err := articleService.ArticleSearch(c.Request.Context(), info)
	if err != nil {
